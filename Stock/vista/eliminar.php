 ...
 <div class="container">
  ...
  <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <input type='hidden' disabled="disabled" name='idStock' id="idStock_d" value='<?php echo $stock->getIdStock()?>'>
                          <div class="col-sm-4">
   ...
   border-style: solid; width: 100%;background-color: #F4ECF7;border-radius: 20px;" align="center">
                        <?php 
                           ...
                           <SELECT  id="idProducto_d" disabled="disabled"  placeholder="*PRODUCTO" required="required" class="" name='idProducto_ed'   style="height: 18px;  background-color: #F5EEF8; margin: none; border:none; width: 93%">
   ...
   border-style: solid; width: 100%;background-color: #F4ECF7;border-radius: 20px;" align="center">
                        <?php 
                           ...
                           <SELECT  id="idSucursal_d" disabled="disabled" placeholder="*TIPO DE PRODUCTO" required="required" class="" name='idSucursal_ed' style="height: 18px;  background-color: #F5EEF8; margin: none; border:none; width: 93%">
                ...
                <?php  }
                  ?>
                      ...
                      <input type="date" style="font-size: 13px" class="form-control colorInput estilord desbloquea" disabled="disabled" required="required" id="fechaIngresoSucursal_d" name='fechaIngresoSucursal_ed' placeholder="*FECHA DE INGRESO" value="<?php echo $stock->getFechaIngresoSucursal()?>">
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 0px; margin-bottom: 0px;">
                      ...
                      <input type="text" class="form-control colorInput estilord " required="required"  id='descripcionStock_d' disabled="disabled" name='descripcionStock_ed' placeholder="*DESCRIPCION" value="<?php echo $stock->getDescripcionStock() ?>">
                        </div>
                        <div class="col-sm-4">
                     <label for="estado" class=" control-label"style="color: purple">Estado</label>
                      <input type="text" class="form-control colorInput estilord" required="required"  id="estadoStock_d" disabled="disabled" name='estadoStock_ed' placeholder="*ESTADO" value="<?php echo $stock->getEstadoStock()?>">
                    </div>
                    <div class="col-sm-4">
                     <label for="costo" class=" control-label"style="color: purple">Cantidad</label>
                        <input type="text" class="form-control estilord" required="required" id='cantidad_ed' name='cantidad_d' disabled="disabled" placeholder="*COSTO PRODCUTO" value="<?php echo $stock->getCantidad() ?>">
                        </div>
                         </div>
                    </div>
