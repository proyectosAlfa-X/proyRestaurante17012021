...
<body>
  ...
  <nav>
    ...
    <label class="logo">RICODELI</label>
      <ul>
         <li><a  class="active" style="text-decoration: none;" href="#">MEN&Uacute; PRINCIPAL</a></li>
		...
		<h3 class="text-center"><b class="text-info">Men&uacute; Principal</b></h3>
	...
	<div class="col-md-4">
	 <a href="../usuario/usuario.php"><img class="img-thumbnail imagen"  src="img/Diapositiva18.png" alt="" /></a>
	</div>
	<!-- cuarta columna-->
